...
int main(void)
{
    ...
    while(1)
    {
        if(mt9v03x_csi_finish_flag)			//图像采集完成
        {
			...
			image_binaryzation();
            //ips200_displayimage032_zoom(mt9v03x_csi_image_after[0], MT9V03X_CSI_W, MT9V03X_CSI_H, MT9V03X_CSI_W, MT9V03X_CSI_H);	//显示二值化图像
			edge_line_search(mt9v03x_csi_image_after[0]);
			//ips200_displayimage032_zoom(mt9v03x_csi_image[0], MT9V03X_CSI_W, MT9V03X_CSI_H, 320, 240);//之前320
